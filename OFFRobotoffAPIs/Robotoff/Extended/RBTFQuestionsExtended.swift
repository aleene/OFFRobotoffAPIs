...
class RBTFQuestionsExtendedRequest: RBTFQuestionsRequest {
...
extension URLSession {
     ...
     */
    func RBTFQuestionsProductExtended(with barcode: OFFBarcode,
                              count: UInt?,
                              lang: ISO693_1?,
    ...
    /**
     ...
     Not all possible query parameters have been implemented, as they are not useful to everyone (server\_domain, reserved\_barcode, capaign, predictor).
     */
    func RBTFQuestionsPopularExtended(languageCode: ISO693_1?,
                                      count: UInt?,
                                      insightTypes: [RBTF.InsightType],
                                      country: Country?,
                                      brands: [String],
                                      ...
                                      page: UInt?,
                                      completion: @escaping (_ result: Result<RBTF.QuestionsResponse, RBTFError>) -> Void) {
        let request = RBTFQuestionsExtendedRequest(api: .questionsPopular,
